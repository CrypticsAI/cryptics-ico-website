...
/**
 * Class Opt_In_Meta_Settings_Slide_In
 *
 *@property string $appear_after
 ...
 *@property bool $hide_after
 *@property int $hide_after_val
 *@property string $hide_after_unit
 *@property string $position
 *@property string $after_close
 *@property bool $enabled
 *@property array $conditions
 */
class Opt_In_Meta_Settings_Slide_In extends Hustle_Meta
{
    var $defaults = array(
        "enabled" =>false,
        "animation_in" =>"",
