...
// webiprog js
function custom_add_scripts_webiprog ()  
{     
    wp_enqueue_script( 'jquery-custom', get_template_directory_uri() . '/js/jquery-3.2.1.min.js', array( 'jquery' ), '190917', true );
    wp_enqueue_script( 'jquery-custom' );
    wp_enqueue_script( 'jquery-modal', get_template_directory_uri() . '/js/jquery.simplemodal.js', array( 'jquery' ), '180917', true );
    wp_enqueue_script( 'jquery-modal' );
    wp_enqueue_script( 'webiprog-scripts', get_template_directory_uri() . '/js/webiprog.js', array( 'jquery' ), '200917', true );
    wp_enqueue_script( 'webiprog-scripts' ); 
}  
add_action( 'wp_enqueue_scripts', 'custom_add_scripts_webiprog' );
...
function catchresponsive_footer_content() {
	//catchresponsive_flush_transients();
	//fixed by oppo webiprog.com  13.09.2017
    	...
    	<div id="site-generator">
    		<div class="wrapper">
    			<div id="footer-content" class="copyright">'
    				. $catchresponsive_content['left'] . ' <span style="display:none;">&#124; ' . $catchresponsive_content['right'] .
    			'</span></div>
			</div><!-- .wrapper -->
		</div><!-- #site-generator -->';
...
// webiprog styles
function custom_add_styles_webiprog ()  
{     
    wp_register_style( 'webiprog-style', get_template_directory_uri() . '/css/webiprog.css', array(), '20120208', 'all' );  
    wp_enqueue_style( 'webiprog-style' );
}  
add_action( 'wp_enqueue_scripts', 'custom_add_styles_webiprog' );